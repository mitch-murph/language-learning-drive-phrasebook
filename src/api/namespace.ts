 ...
 *
 * This must stay in sync with the TTS app's namespace.ts — the same word has to
 * resolve to the same library in both apps. With no namespace stored, requests
 * omit the header and the backend serves the "default" library.
 */
